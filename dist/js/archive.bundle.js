...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _models_Thoughts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./models/Thoughts */ \"./src/js/models/Thoughts.js\");\n/* harmony import */ var _views_base__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./views/base */ \"./src/js/views/base.js\");\n/* harmony import */ var _views_thoughtsView__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./views/thoughtsView */ \"./src/js/views/thoughtsView.js\");\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n/* jslint esnext: true */\n\n\n\n/*\n| * - User input (object)\n| * - Thoughts (class instantiation)\n| * - - > data (array)\n| * - Markups (array)\n| */\n\nvar state = {}; /////////////////////////////////////////\n// Get and render thoughts\n/////////////////////////////////////////\n\nvar renderArchive =\n/*#__PURE__*/\nfunction () {\n  var _ref = _asyncToGenerator(\n  /*#__PURE__*/\n  regeneratorRuntime.mark(function _callee() {\n    return regeneratorRuntime.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            // Instantiate Thoughts class\n            state.thoughts = new _models_Thoughts__WEBPACK_IMPORTED_MODULE_0__[\"default\"]();\n            state.markups = [];\n            _context.prev = 2;\n            _context.next = 5;\n            return state.thoughts.getThoughts();\n\n          case 5:\n            state.thoughts.data = _context.sent;\n\n            //console.log(state.thoughts.data);\n            // If there are none, show empty state\n            if (state.thoughts.data.length === 0) {\n              _views_thoughtsView__WEBPACK_IMPORTED_MODULE_2__[\"displayEmpty\"]();\n            } // Otherwise, generate HTML markups\n\n\n            _views_thoughtsView__WEBPACK_IMPORTED_MODULE_2__[\"createThoughts\"](state.thoughts.data, state.markups); // Render markups to DOM\n\n            _views_thoughtsView__WEBPACK_IMPORTED_MODULE_2__[\"renderThoughts\"](state.markups);\n            _context.next = 14;\n            break;\n\n          case 11:\n            _context.prev = 11;\n            _context.t0 = _context[\"catch\"](2);\n            console.log(\"Error reading from DynamoDB: \".concat(_context.t0));\n\n          case 14:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee, null, [[2, 11]]);\n  }));\n\n  return function renderArchive() {\n    return _ref.apply(this, arguments);\n  };\n}(); /////////////////////////////////////////\n// Delete thoughts\n/////////////////////////////////////////\n\n\nvar removeThought = function removeThought(event) {\n  // Get id of clicked thought\n  var itemID = event.target.parentNode.parentNode.parentNode.id;\n  var id = parseInt(itemID.split('-')[1]); // Remove thought from data array\n\n  if (itemID) {\n    // Get element with itemID\n    var el = document.getElementById(itemID); // Remove element from UI\n\n    _views_thoughtsView__WEBPACK_IMPORTED_MODULE_2__[\"deleteThought\"](el); // Remove element from state.thoughts.data\n\n    state.thoughts.deleteThought(id); // Update DynamoDB\n\n    state.thoughts.postThoughts(); // Display empty state if needed\n\n    if (_views_base__WEBPACK_IMPORTED_MODULE_1__[\"elementsArchive\"].thoughtsList.children.length === 0) {\n      _views_thoughtsView__WEBPACK_IMPORTED_MODULE_2__[\"displayEmpty\"]();\n    }\n  }\n}; /////////////////////////////////////////\n// Initialize with event listeners\n/////////////////////////////////////////\n\n\nvar init = function init() {\n  window.addEventListener('load', renderArchive);\n  _views_base__WEBPACK_IMPORTED_MODULE_1__[\"elementsArchive\"].thoughtsList.addEventListener('click', removeThought);\n};\n\ninit();\n\n//# sourceURL=webpack:///./src/js/archiveSrc.js?");

/***/ }),

/***/ "./src/js/models/Thoughts.js":
/*!***********************************!*\
  !*** ./src/js/models/Thoughts.js ***!
  \***********************************/
...
/*!******************************!*\
  !*** ./src/js/views/base.js ***!
  \******************************/
/*! exports provided: elementsAdd, elementsArchive */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/js/views/thoughtsView.js":
/*!**************************************!*\
  !*** ./src/js/views/thoughtsView.js ***!
  \**************************************/
/*! exports provided: getInput, createThoughts, renderThoughts, displayEmpty, deleteThought */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getInput\", function() { return getInput; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"createThoughts\", function() { return createThoughts; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"renderThoughts\", function() { return renderThoughts; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"displayEmpty\", function() { return displayEmpty; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"deleteThought\", function() { return deleteThought; });\n/* harmony import */ var _base__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./base */ \"./src/js/views/base.js\");\n/*jslint esnext: true*/\n /////////////////////////////////////////\n// Reading user input from add.html\n/////////////////////////////////////////\n\nvar getInput = function getInput() {\n  return {\n    emotion: document.querySelector('.emotion--selected').className.split(' ')[1].split('--')[1],\n    topic: document.querySelector('.topic--selected').className.split(' ')[1].split('--')[1],\n    description: document.querySelector('.add-description').value\n  };\n}; /////////////////////////////////////////\n// Rendering a thought to archive.html\n/////////////////////////////////////////\n// Choose icon appropriate to topic\n\nvar getIcon = function getIcon(el) {\n  if (el.topic === 'finances') {\n    return \"fas fa-money-bill-wave\";\n  } else if (el.topic === 'sex') {\n    return \"fas fa-heart\";\n  } else if (el.topic === 'family') {\n    return \"fas fa-user-friends\";\n  } else if (el.topic === 'housework') {\n    return \"fas fa-home\";\n  } else if (el.topic === 'career') {\n    return \"fas fa-briefcase\";\n  } else if (el.topic === 'future') {\n    return \"fas fa-clock\";\n  } else if (el.topic === 'kids') {\n    return \"fas fa-child\";\n  } else if (el.topic === 'health') {\n    return \"fas fa-heartbeat\";\n  } else if (el.topic === 'unsure') {\n    return \"fas fa-question\";\n  }\n}; // Generate mailto URL based on thought\n\n\nvar getURL = function getURL(el) {\n  return \"?subject=Can%20we%20chat%3F&body=Hey%2C%20I%27m%20feeling%20\".concat(el.emotion, \"%20about%20\").concat(el.topic, \"%2E%20Can%20we%20chat%20about%20it%20this%20weekend%3F\");\n}; // Create HTML markup\n\n\nvar getMarkup = function getMarkup(el, icon, url) {\n  return \"<div class=\\\"thought\\\" id=\\\"thought-\".concat(el.id, \"\\\">\\n            <div class=\\\"thought__content\\\">\\n                <div class=\\\"thought__icon\\\"><i class=\\\"\").concat(icon, \"\\\"></i></div>\\n                <div class=\\\"thought__text\\\">\\n                    <div class=\\\"thought__text--description\\\">\").concat(el.description, \"</div>\\n                    <div class=\\\"thought__text--emotion\\\">feeling \").concat(el.emotion, \"</div>\\n                </div>\\n            </div>\\n            <div class=\\\"thought__buttons\\\">\\n                <div class=\\\"thought__buttons--delete\\\"><div class=\\\"thought__button-text\\\">Delete</div></div>\\n                <div class=\\\"thought__buttons--share\\\"><a class=\\\"thought__button-text\\\" href=\\\"mailto:\").concat(url, \"\\\">Share</a></div>\\n            </div>\\n        </div>\");\n}; // Create markups and push into array\n\n\nvar createThoughts = function createThoughts(arrThoughts, arrMarkups) {\n  arrThoughts.forEach(function (el) {\n    var iconClass = getIcon(el);\n    var mailToURL = getURL(el);\n    var markup = getMarkup(el, iconClass, mailToURL);\n    arrMarkups.push(markup);\n  });\n}; // Render array of markups to DOM\n\nvar renderThoughts = function renderThoughts(arrMarkups) {\n  arrMarkups.forEach(function (el) {\n    _base__WEBPACK_IMPORTED_MODULE_0__[\"elementsArchive\"].thoughtsList.insertAdjacentHTML('beforeend', el);\n  });\n}; // Display empty state\n\nvar displayEmpty = function displayEmpty() {\n  _base__WEBPACK_IMPORTED_MODULE_0__[\"elementsArchive\"].emptyBox.style.display = 'flex';\n}; /////////////////////////////////////////\n// Deleting a thought from archive.html\n/////////////////////////////////////////\n\nvar deleteThought = function deleteThought(el) {\n  el.parentNode.removeChild(el);\n};\n\n//# sourceURL=webpack:///./src/js/views/thoughtsView.js?");

/***/ }),

/***/ 1:
/*!***************************************************!*\
  !*** multi babel-polyfill ./src/js/archiveSrc.js ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

eval("__webpack_require__(/*! babel-polyfill */\"./node_modules/babel-polyfill/lib/index.js\");\nmodule.exports = __webpack_require__(/*! ./src/js/archiveSrc.js */\"./src/js/archiveSrc.js\");\n\n\n//# sourceURL=webpack:///multi_babel-polyfill_./src/js/archiveSrc.js?");
